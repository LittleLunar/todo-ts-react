  ...
  return (
    <div className="container w-full md:w-[95%] flex flex-col md:flex-row justify-between items-start">
      <Droppable droppableId="TodosList">
        {(provided, snapshot) => (
          <div
            className={`flex flex-col items-center p-[15px] rounded-[5px] bg-[#32c3cd] w-full md:w-[47.5%] mb-[10px] md:mb-0 ${
      ...
      <Droppable droppableId="TodosRemove">
        {(provided, snapshot) => (
          <div
            className={`flex flex-col items-center p-[15px] rounded-[5px] bg-[#eb6750] w-full md:w-[47.5%] mb-[10px] md:mb-0 ${
              snapshot.isDraggingOver ? "bg-[#ff2600]" : ""
            }`}
            ref={provided.innerRef}
            {...provided.droppableProps}
          >
